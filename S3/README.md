...
| <a name="input_logging"></a> [logging](#input\_logging) | Map containing access bucket logging configuration. </br> **target\_bucket**: name of the bucket to log to. </br> **target\_prefix**: prefix to use when logging | `map(string)` | `{}` | no |
