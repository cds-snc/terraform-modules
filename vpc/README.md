...
| <a name="output_main_nacl_id"></a> [main\_nacl\_id](#output\_main\_nacl\_id) | The ID of the main network ACL. |
...
| <a name="output_public_ips"></a> [public\_ips](#output\_public\_ips) | The public IP addresses of the NAT gateways. |
