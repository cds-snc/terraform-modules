...
| <a name="input_deployment_managed_by_code_deploy"></a> [deployment\_managed\_by\_code\_deploy](#input\_deployment\_managed\_by\_code\_deploy) | Determines whether ECS should let AWS CodeDeploy handle deployments | `bool` | `false` | no |
