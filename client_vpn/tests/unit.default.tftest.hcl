...
run "default" {
  ...
  assert {
    condition     = strcontains(aws_iam_saml_provider.client_vpn_self_service.saml_metadata_document, "https://portal.sso.ca-central-1.amazonaws.com/saml/logout/abcdef")
