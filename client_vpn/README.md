...
| <a name="input_certificate_early_renewal_period"></a> [certificate\_early\_renewal\_period](#input\_certificate\_early\_renewal\_period) | (Optional, default 672) The early renewal period for the VPN client certificate in hours. | `number` | `672` | no |
| <a name="input_certificate_validity_period"></a> [certificate\_validity\_period](#input\_certificate\_validity\_period) | (Optional, default 8760) The validity period of the VPN client certificate in hours. | `number` | `8760` | no |
