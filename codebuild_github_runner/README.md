...
| [aws_codebuild_source_credential.this_codeconnections](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/codebuild_source_credential) | resource |
...
| <a name="input_environment_image"></a> [environment\_image](#input\_environment\_image) | (Optional, default 'aws/codebuild/amazonlinux-x86\_64-standard:6.0') Image for the CodeBuild environment. | `string` | `"aws/codebuild/amazonlinux-x86_64-standard:6.0"` | no |
